...
| `type` | Crossing type: 4=car UA→EU (default), 5=car EU→UA, 6=bus, 7=pedestrian, 8=truck (Freight Transport), 9=truck up to 7.5 t |
...
```bash
curl "https://nakordoni.eu/api/v1/data/travel-matrix?origin_lat=50.06&origin_lon=19.94&type=4&dest=1&lang=en" \
